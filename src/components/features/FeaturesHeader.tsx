...
const FeaturesHeader: React.FC = () => {
  return (
    <>
      <div className="text-slate-800 text-center text-5xl font-bold leading-[58px] tracking-wide w-[499px] max-md:w-full max-md:text-4xl max-md:leading-10 max-md:mt-10">
